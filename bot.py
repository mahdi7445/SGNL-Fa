...
TREND_ALTS_MIN_VOLUME_USD = float(os.environ.get("TREND_ALTS_MIN_VOLUME_USD", "10000000"))
TREND_ALTS_MIN_MARKET_CAP_USD = float(os.environ.get("TREND_ALTS_MIN_MARKET_CAP_USD", "500000000"))
...
DAILY_REPORT_HOUR_UTC = int(os.getenv("DAILY_REPORT_HOUR_UTC", "21"))  # همان پیش‌فرض ربات VIP - یعنی طبق پیش‌فرض دقیقاً همان ساعت
