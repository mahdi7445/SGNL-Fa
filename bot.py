...
TREND_ALTS_MIN_VOLUME_USD = float(os.environ.get("TREND_ALTS_MIN_VOLUME_USD"))
TREND_ALTS_MIN_MARKET_CAP_USD = float(os.environ.get("TREND_ALTS_MIN_MARKET_CAP_USD"))
